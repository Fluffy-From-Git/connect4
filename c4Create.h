...
// Frees all memory allocated to the given game state
void freeGameState(GameState *game);

// Frees all memory allocated to the given board
void freeBoard(BoardCell **board);

// Frees all memory allocated to the given valid positions
void freeValidPositions(GameState *game);
...
// Inserts the valid position into the given game state
void insertPosition(GameState *game, int row, int col);
